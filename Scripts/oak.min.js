...
function Oak_gen_MIPS() {
    ...
    instructions.push(new Instruction("RPR", rcSubtype, ["funct"], [36], function (core) {
        return null;
    }, function (core) {
        return null;
    }, function (core) {
    ...
    instructions.push(new Instruction("JPR", jType, ["opcode"], [32], function (core) {
        return null;
    }, function (core) {
        return null;
    }, function (core) {
    ...
    MIPSCore.prototype.cycle = function () {
        ...
        if (this.rfBubble.valid && this.rfBubble.instruction) {
            if (this.rfBubble.instruction.format.name == "IB") {
                ...
                if (branching != this.rfBubble.prediction) {
                    if (branching) {
